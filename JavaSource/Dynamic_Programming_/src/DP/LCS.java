...
public class LCS {
	...
	public static int LCSRecursionVIdx(String s1, String s2, int idx1, int idx2) {
		...
		if (ch1 == ch2) {
			ans = LCSRecursionVIdx(s1, s2, idx1 + 1, idx2 + 1) + 1;
		} else {
			int o1 = LCSRecursionVIdx(s1, s2, idx1, idx2 + 1);
			int o2 = LCSRecursionVIdx(s1, s2, idx1 + 1, idx2);
